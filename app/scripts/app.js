...
angular.module('angularTabsAppInternal', []);
angular.module('rocketFactoryAppInternal', []);
angular.module('rocketCatalogAppInternal', ['rocketFactoryAppInternal', 'angularTabsAppInternal']);
...
angular
  .module('rocketCatalogApp', ['rocketCatalogAppInternal', 'rocketCatalogTranslations', 'wixAngular', 'ngAnimate'])
  .config(function () {
    return;
  });
